export default function E(p) {
  ...
  this.draw = () => {
    ...
    //STORY TEXT
    if (!this.storyCompleted && timeSinceStart > 3000) {
    ...
    const timeSinceStory = this.storyCompleted
      ? p.millis() - this.storyCompleted
      : null;
    this.coral.drawE(p, timeSinceStory);
  };
}
